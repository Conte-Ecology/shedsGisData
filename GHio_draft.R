...
The Daymet [repository](https://github.com/Conte-Ecology/shedsData/tree/master/daymet) 
documents the process for assigning a climate timeseries to each hydrologic catchment 
in the NHDHRDV2. Currently, daily values are assigned to 
