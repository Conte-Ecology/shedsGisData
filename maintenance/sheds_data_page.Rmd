...
catchments <- read.csv("C:/KPONEIL/GitHub/projects/shedsData/maintenance/NHDHRDV2/spatial_doc_tables/catchments.csv")
truncated_flowlines <- read.csv("C:/KPONEIL/GitHub/projects/shedsData/maintenance/NHDHRDV2/spatial_doc_tables/truncated_flowlines.csv")
detailed_flowlines <- read.csv("C:/KPONEIL/GitHub/projects/shedsData/maintenance/NHDHRDV2/spatial_doc_tables/detailed_flowlines.csv")
region_boundary <- read.csv("C:/KPONEIL/GitHub/projects/shedsData/maintenance/NHDHRDV2/spatial_doc_tables/region_boundary.csv")
```
